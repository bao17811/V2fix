...
module.exports.handleEvent = function({ api, event }) {
  ...
  if ((event.body.toLowerCase() == "@Bao Nguyen") || (event.body.toLowerCase() == "@Bao Nguyen")) {
    return api.sendMessage("Admin bot đi ngủ òi :v", threadID);
  };
